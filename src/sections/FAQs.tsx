      ...
      <div className="container">
        ...
        <div className="mt-10 md:mt-16 lg:mt-20">
          {faqs.map(({ question, answer }, faqIndex) => (
            <div key={question}
              className="border-t last:border-b border-stone-400 relative isolate group/faq border-dotted py-6 md:py-8 lg:py-10" onClick={() => {
              ...
              <div className={twMerge("flex justify-between items-center gap-4 transition-all duration-700 group-hover/faq:md:px-4", faqIndex === selectedIndex && 'md:px-4')}>
              ...
              <AnimatePresence>
                {faqIndex === selectedIndex && (
                  ...
                  >
                    <p className="text-xl md:text-2xl mt-4">{answer}</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
